...
class PipelineGraphViewNestedTest {
    ...
    void smokeTest(Page p, JenkinsConfiguredWithCodeRule j) throws Exception {
        ...
        new PipelineJobPage(p, run.getParent())
                ...
                .goToBuild()
                .hasStagesInGraph(6, /*A*/ "Checkout", "A1", "A2", /*B*/ "Build", "B1", "B2")
                .goToPipelineOverview()
                .hasStagesInGraph(6, /*A*/ "Checkout", "A1", "A2", /*B*/ "Build", "B1", "B2")
                .searchForStage("Test")
                .selectStageInTree("Test")
                .stageIsSelectedInLogs("Test")
                .clearSearch()
                .selectStageInGraph("B1")
                .stageIsSelected("B1")
